            ...
            <>
              <div className="grid grid-cols-3 gap-4">
                <div className="dark:bg-white/5 bg-slate-100 rounded-xl p-4 border dark:border-white/5 border-slate-200">
                  <p className="text-[10px] font-mono uppercase dark:text-gray-400 text-slate-600 font-bold mb-1">
                    Minimum
                  </p>
                  <p className="text-2xl font-bold text-red-600 dark:text-red-400 font-mono">
                    {powerStats.min.toFixed(2)}
                    <span className="text-xs dark:text-gray-400 text-slate-600 font-normal"> mW</span>
                  </p>
                </div>
                <div className="dark:bg-white/5 bg-slate-100 rounded-xl p-4 border dark:border-white/5 border-slate-200">
                  <p className="text-[10px] font-mono uppercase dark:text-gray-400 text-slate-600 font-bold mb-1">
              ...
              <div className="mt-4 dark:bg-white/5 bg-slate-100 rounded-xl p-4 border dark:border-white/5 border-slate-200">
                <p className="text-xs dark:text-gray-300 text-slate-700 leading-relaxed font-normal">
          ...
          body: (
            <>
              <div className="dark:bg-white/5 bg-slate-100 rounded-xl p-4 border dark:border-white/5 border-slate-200 mb-4">
                <p className="text-[10px] font-mono uppercase dark:text-gray-400 text-slate-600 font-bold mb-2">
                  Current Total
                </p>
                <p className="text-4xl font-bold text-emerald-600 dark:text-emerald-400 text-glow font-mono">
                  {currentValues.totalEnergy.toFixed(2)}{' '}
                  <span className="text-lg dark:text-gray-400 text-slate-600 font-normal">mWh</span>
                </p>
              </div>
              <div className="space-y-2 text-sm dark:text-gray-300 text-slate-700">
            ...
            <>
              ...
              <div className="dark:bg-white/5 bg-slate-100 rounded-xl p-4 border dark:border-white/5 border-slate-200">
                <div className="flex justify-between text-sm mb-2">
                  <span className="dark:text-gray-300 text-slate-700">Charge Level</span>
                  <span className="font-mono text-emerald-600 dark:text-emerald-400 font-bold">
                ...
                <p className="text-xs dark:text-gray-400 text-slate-600 mt-3">
            ...
            <>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="dark:bg-white/5 bg-slate-100 rounded-xl p-4 border dark:border-white/5 border-slate-200 text-center">
                  ...
                  <p className="text-3xl font-bold text-sky-600 dark:text-sky-400 font-mono">
                    {currentValues.liveHum.toFixed(1)}%
                  </p>
                </div>
              </div>
              <p className="text-xs dark:text-gray-300 text-slate-700 mt-4 leading-relaxed font-normal">
        ...
        >
          ...
          >
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                <p className="text-[10px] font-mono uppercase tracking-widest text-emerald-600 dark:text-emerald-400 mb-1 font-bold">
                  {content.label}
                </p>
